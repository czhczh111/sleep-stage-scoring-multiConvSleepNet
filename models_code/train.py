...
from load_files import load_npz_files, train_npzs, valid_npzs
...
#     os.environ["CUDA_VISIBLE_DEVICES"] = "-1"
    ...
    #训练
    print("valid_npzs:",valid_npzs)   #若干个string的list
    print("train_npzs:",train_npzs)   #若干个string的list
    ...
    callback_list = [callbacks.EarlyStopping(monitor = 'acc', patience = hyper_param_dict['patience']),
                     callbacks.ModelCheckpoint(filepath = os.path.join(res_path, f"{model_name}_best_model.h5"),
